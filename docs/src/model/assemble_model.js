...
export function assembleModel({
  ...
  return {
    ...
    innerHullModel: innerHullModel ?? null,
    outerHullModel: outerHullModel ?? null,
    hullProofs: hullProofs ?? null,
    citadelFit: citadelFit ?? null,
    coastGeometry: coastGeometry ?? null,
