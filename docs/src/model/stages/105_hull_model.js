...
function pointDistanceToPolyBoundary(p, poly) {
...
function pointDistanceToPolygonSamples(p, poly) {
...
function polygonClearOfPoint(poly, point, clearance) {
  if (!Array.isArray(poly) || poly.length < 3) return false;
...
function scalePolyToward(poly, centre, scale) {
